...
const Button = ({
  ...
  const buttonClasses = twMerge(
    ...
    size === 'medium' && 'h-10 md:h-[44px] px-4 py-3 text-base leading-[22px]',
    size === 'large' && 'h-12 md:h-[56px] px-6 py-4 text-xl leading-[30px]',
    ...
    variant === 'icon' &&
      'border-text-4 border hover:bg-bunker-100 hover:bg-opacity-80 h-10 md:h-[44px] w-[44px] !p-0 flex items-center justify-center',
