...
const EyeIcon = (props: SvgIconsCommonProps) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M14.1218 9.87975C15.2928 11.0508 15.2928 12.9518 14.1218 14.1248C12.9508 15.2958 11.0498 15.2958 9.87679 14.1248C8.70579 12.9538 8.70579 11.0527 9.87679 9.87975C11.0498 8.70675 12.9498 8.70675 14.1218 9.87975"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
