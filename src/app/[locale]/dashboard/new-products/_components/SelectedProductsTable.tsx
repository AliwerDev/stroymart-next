...
const SelectedProductsTable = ({ products = [], removeProduct }: SelectedProductsTableProps) => {
  ...
  return <Table data={products} columns={columns} hidePagination onRowClick={removeProduct} />;
};
